...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  const API_KEY = 'AIzaSyByY4zMdt06Od_t-dNnCWNTZPBvPy5jUSw';  // Replace with your actual YouTube Data API key
  // const API_URL = 'http://my-elb-2062136355.us-east-1.elb.amazonaws.com:80';   
  //const API_URL = 'http://localhost:5000/';
  const API_URL = 'https://youtubecommentssentimentanalysis.onrender.com/';
